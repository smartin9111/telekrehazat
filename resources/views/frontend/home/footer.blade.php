        ...
        <div class="auto-container">
            <div class="inner-box clearfix">
                ...
                <div class="copyright pull-left">
                    <p><a href="index.html">TELEKREHÁZAT</a> &copy; 2023 Minden jog fentartva!</p>
                </div>
                <ul class="footer-nav pull-right clearfix">
                    <li><a href="index.html">Szolgáltatás feltételei</a></li>
                    <li><a href="index.html">Adatvédelmi irányelvek</a></li>
                </ul>
            </div>
        </div>
    </div>
